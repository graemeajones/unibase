    ...
    services: {
      get: [
        ...
        },
        {
          ...
          example: `${API_URL}/proposals/assessments/13/users/275/proposedby`,
        },
        {
          ...
          example: `${API_URL}/proposals/assessments/13/users/275/whoproposed`,
        },
      ],
      post: {
        endpoint: '/',
    ...
    services: {
      get: [
        ...
        },
        {
          ...
          examples: [
            `${API_URL}/users/assessments/13/proposedby/275`,
            `${API_URL}/users/assessments/13/proposedby/275?UserProposalConfirmationID=1`,
          ],
        },
        {
          ...
          example: `${API_URL}/users/assessments/13/whoproposed/275`,
        },
      ],
      post: {
        endpoint: '/',
