...
const listOfEndpoints = [
  {
    ...
    services: {
      get: [
        ...
        {
          endpoint: '/users/{id}',
          description: 'Returns the set of assessments associated with the user identified by the id provided',
          examples: [
  ...
  },
  {
    ...
    services: {
      get: [
        ...
        {
          endpoint: '/user/{id}',
          description: 'Returns the set of favourites associated with the user identified by the id provided',
          examples: [
    ...
    services: {
      get: [
        ...
        },
        {
          ...
          description: 'Returns the set of like/dislike records generated by the student identified by the id provided',
          examples: [
  ...
  },
  {
    ...
    services: {
      get: [
        ...
        {
          endpoint: '/likedby/{id}',
          description: 'Returns the set of users liked (or disliked) by the user identified by the id provided',
          examples: [`${API_URL}/users/likedby/277`, `${API_URL}/users/likedby/277?UserLikeAffinityName=Like`],
        },
        {
          endpoint: '/wholike/{id}',
          description: 'Returns the set of users who like (or dislike) the user identified by the id provided',
          examples: [`${API_URL}/users/wholike/277`, `${API_URL}/users/wholike/277?UserLikeAffinityID=2`],
        },
      ],
      post: {
        endpoint: '/',
