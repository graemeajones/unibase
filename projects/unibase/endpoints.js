  ...
  },
  {
    ...
    services: {
      get: [
        ...
        {
          endpoint: '/{id}',
          description: 'Returns the specific workshop identified by the id provided',
        ...
        },
        {
          ...
          examples: [`${API_PATH}/workshops/modules/4`],
        },
      ],
      post: {
        endpoint: '/',
      ...
      put: {
        endpoint: '/{id}',
        description: 'Update the specific workshop identified by the id provided',
      },
      delete: {
        endpoint: '/{id}',
        description: 'Delete the specific workshop record identified by the id provided',
      },
    },
  },
  {
