...
import workshopsRouter from "./routers/workshops-router.js";
...
const listOfEndpoints = [
  {
    ...
    services: {
      ...
      put: {
        endpoint: "/{id}",
        description:
          "Update the specific assessment identified by the id provided",
      },
      delete: {
        endpoint: "/{id}",
        description:
          "Delete the specific assessment identified by the id provided",
      },
    },
  },
  {
    ...
    services: {
      ...
      put: {
        endpoint: "/{id}",
        description:
          "Update the specific assessment type identified by the id provided",
      },
      delete: {
        endpoint: "/{id}",
        description:
          "Delete the specific assessment type identified by the id provided",
      },
    },
  },
  {
    ...
    services: {
      get: [
        ...
        },
        {
          endpoint: "/{id}",
          description:
            "Returns the specific attendance type identified by the id provided",
    ...
    services: {
      get: [
        ...
        },
        {
          endpoint: "/{id}",
          description:
            "Returns the specific completion type identified by the id provided",
    ...
    services: {
      get: [
        ...
        },
        {
          endpoint: "/{id}",
          description:
            "Returns the specific confirmation identified by the id provided",
    ...
    services: {
      get: [
        ...
        },
        {
          endpoint: "/{id}",
          description:
            "Returns the specific contribution identified by the id provided",
      ...
      put: {
        endpoint: "/{id}",
        description:
          "Update the specific contribution identified by the id provided",
      },
      delete: {
        endpoint: "/{id}",
        description:
          "Delete the specific contribution record identified by the id provided",
      },
    },
  },
  {
      ...
      get: [
        {
          ...
          examples: [
            `${API_PATH}/favourites`,
            `${API_PATH}/favourites?FavouriteCategory=Groups`,
          ],
        },
        {
          endpoint: "/{id}",
          description:
            "Returns the specific favourite identified by the id provided",
    ...
    services: {
      get: [
        ...
        },
        {
          endpoint: "/{id}",
          description:
            "Returns the specific group identified by the id provided",
    ...
    services: {
      get: [
        ...
        },
        {
          endpoint: "/{id}",
          description:
            "Returns the specific group member record identified by the id provided",
      ...
      put: {
        endpoint: "/{id}",
        description:
          "Update the specific group member record identified by the id provided",
      },
      delete: {
        endpoint: "/{id}",
        description:
          "Delete the specific group member record identified by the id provided",
      },
    },
  },
  {
    ...
    services: {
      get: [
        {
          ...
          examples: [
            `${API_PATH}/likes`,
            `${API_PATH}/likes?LikeAffinityName=Like`,
          ],
        },
        {
          endpoint: "/{id}",
          description:
            "Returns the specific like record identified by the id provided",
      ...
      put: {
        endpoint: "/{id}",
        description:
          "Update the specific like record identified by the id provided",
      },
      delete: {
        endpoint: "/{id}",
        description:
          "Delete the specific like record identified by the id provided",
      },
    },
  },
  {
    ...
    services: {
      get: [
        ...
        },
        {
          endpoint: "/{id}",
          description:
            "Returns the specific link record identified by the id provided",
      ...
      put: {
        endpoint: "/{id}",
        description:
          "Update the specific link record identified by the id provided",
      },
      delete: {
        endpoint: "/{id}",
        description:
          "Delete the specific link record identified by the id provided",
      },
    },
  },
  {
    ...
    services: {
      ...
      delete: {
        endpoint: "/{id}",
        description:
          "Delete the specific log record identified by the id provided",
      },
    },
  },
  {
    ...
    services: {
      get: [
        ...
        },
        {
          endpoint: "/{id}",
          description:
            "Returns the specific module identified by the id provided",
      ...
      put: {
        endpoint: "/{id}",
        description:
          "Update the specific module record identified by the id provided",
      },
      delete: {
        endpoint: "/{id}",
        description:
          "Delete the specific module record identified by the id provided",
      },
    },
  },
  {
    ...
    services: {
      get: [
        ...
        },
        {
          endpoint: "/{id}",
          description:
            "Returns the specific module member record identified by the id provided",
      ...
      put: {
        endpoint: "/{id}",
        description:
          "Update the specific module member record identified by the id provided",
      },
      delete: {
        endpoint: "/{id}",
        description:
          "Delete the specific module member record identified by the id provided",
      },
    },
  },
  {
    ...
    services: {
      get: [
        ...
        },
        {
          endpoint: "/{id}",
          description:
            "Returns the specific project identified by the id provided",
      ...
      put: {
        endpoint: "/{id}",
        description:
          "Update the specific project record identified by the id provided",
      },
      delete: {
        endpoint: "/{id}",
        description:
          "Delete the specific project record identified by the id provided",
      },
    },
  },
  {
    ...
    services: {
      get: [
        ...
        },
        {
          endpoint: "/{id}",
          description:
            "Returns the specific project status identified by the id provided",
    ...
    services: {
      get: [
        ...
        },
        {
          endpoint: "/{id}",
          description:
            "Returns the specific proposal identified by the id provided",
      ...
      put: {
        endpoint: "/{id}",
        description:
          "Update the specific proposal identified by the id provided",
      },
      delete: {
        endpoint: "/{id}",
        description:
          "Delete the specific proposal identified by the id provided",
      },
    },
  },
  {
    ...
    services: {
      get: [
        ...
        },
        {
          endpoint: "/staff",
          description:
            "Returns those user records associated with the usertype staff",
        ...
        },
        {
          ...
          description:
            "Returns the set of users in a specific module liked by a specific user",
  ...
  },
  {
    ...
    services: {
      get: [
        {
          endpoint: "/",
          description: "Returns all workshops",
          examples: [`${API_PATH}/workshops`],
        },
        {
          endpoint: "/{id}",
          description:
            "Returns the specific workshop identified by the id provided",
          examples: [`${API_PATH}/workshops/1`],
        },
        {
          endpoint: "/modules/{id}",
          description:
            "Returns the set of workshops associated with the module identified by the id provided",
          examples: [`${API_PATH}/workshops/modules/1`],
        },
      ],
      post: {
        endpoint: "/",
        description: "Insert a new workshop record",
      },
      put: {
        endpoint: "/{id}",
        description:
          "Update the specific workshop identified by the id provided",
      },
      delete: {
        endpoint: "/{id}",
        description:
          "Delete the specific workshop record identified by the id provided",
      },
    },
  },
  {
    ...
    services: {
      get: [
        ...
        },
        {
          endpoint: "/{id}",
          description:
            "Returns the specific year record identified by the id provided",
      ...
      put: {
        endpoint: "/{id}",
        description:
          "Update the specific year record identified by the id provided",
      },
      delete: {
        endpoint: "/{id}",
        description:
          "Delete the specific year record identified by the id provided",
      },
    },
  },
];
