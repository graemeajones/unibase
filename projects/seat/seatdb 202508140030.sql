...
--
-- Host: 141.94.205.33
-- Generation Time: Aug 14, 2025 at 01:31 AM
...
CREATE TABLE `Attendees` (
  ...
  `AttendeeSeat` varchar(64) DEFAULT NULL
...
INSERT INTO `Attendees` (`AttendeeID`, `AttendeeUserID`, `AttendeeEventID`, `AttendeeStatusID`, `AttendeeSeat`) VALUES
(1, 2, 41, 5, '3.9'),
(2, 4, 41, 5, '8.5'),
(3, 5, 41, 5, '3.5'),
(4, 6, 41, 2, '1.2'),
