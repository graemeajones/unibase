...
import schema from '../schemas/myduties-schema.js';
import modelConfig from '../models/myduties-model.js';
...
router.get('/duties/:id(\\d+)', (req, res) => controller.get(req, res, 'duties'));
